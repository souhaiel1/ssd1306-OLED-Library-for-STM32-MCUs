 ...
 *
 * Library features include functions for drawing lines, rectangles ,circles , patterns(bitmaps)
 */
 ...
 * @note   This function must be called each time you do some changes to OLED, to update buffer from RAM to LCD
 * @param  None
 * @retval None
 */
 ...
 * @note   @ref SSD1306_UpdateScreen() must be called after that in order to see updated OLEDscreen
